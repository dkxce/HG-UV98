...
-   Поддерживает SignaLink USB модемы
  ...
  * Степень дискретизации (TX Sample Rate): 11025 Гц.
  * Задержк апри передаче (TX Delay): Рекомендуется установить от 250 до 350 мс (а для некоторых радиостанций Baofeng, у которых медленно открывается шумоподавитель — до 400-500 мс)
